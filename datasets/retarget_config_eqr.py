...
URDF_FILENAME = "{LEGGED_GYM_ROOT_DIR}/resources/robots/eqr1_description/urdf/eqr1_pin.urdf".format(
    LEGGED_GYM_ROOT_DIR=LEGGED_GYM_ROOT_DIR)

OUTPUT_DIR = "{LEGGED_GYM_ROOT_DIR}/datasets/mocap_motions_eqr".format(
    LEGGED_GYM_ROOT_DIR=LEGGED_GYM_ROOT_DIR)
...
DEFAULT_JOINT_POSE = np.array([0, -0.5, 1.1, 0, -0.5, 1.1, 0, -0.5, 1.1, 0, -0.5, 1.1])
...
FR_FOOT_NAME = "fr_leg_lee"
FL_FOOT_NAME = "fl_leg_lee"
HR_FOOT_NAME = "hr_leg_lee"
HL_FOOT_NAME = "hl_leg_lee"
