...
class PolicyExporter(torch.nn.Module):
    ...
    def forward(self, observations_total):
        obs = observations_total[:,:45]
        obs_history = observations_total[:,45:]
...
if __name__ == '__main__':
    path = '/home/ehr/wxy/legged_gym_wxy/logs/rough_eqr/May14_21-50-17_student_test/'
    model_name = 'model_30000.pt'
